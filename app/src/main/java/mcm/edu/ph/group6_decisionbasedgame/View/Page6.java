...
public class Page6 extends AppCompatActivity implements View.OnClickListener, ServiceConnection {
    ...
    private ImageView darkShade6, btn6Menu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn6Menu = findViewById(R.id.btn6Menu);
        ...
        btn6Menu.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn6Menu:
                Intent goToMenu = new Intent(Page6.this, MenuScreen.class);
